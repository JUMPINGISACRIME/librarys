--[[
    SEMI MODIFIED THUGSENSE

    add targethud avatar outline and healthbar outlines
]]
...
local Library do
    ...
    Library = {
        ...
        Theme = {
            ...
            ["Page Background"] = FromRGB(20, 20, 25),
            ["Border"] = FromRGB(10, 10, 10),
            ["Outline"] = FromRGB(27, 27, 32),
            ["Accent"] = FromRGB(158, 177, 211),
            ["Element"] = FromRGB(27, 27, 32),
    ...
    Library.Watermark = function(self, Name)
        ...
        task.spawn(function()
            ...
            local function FormatSessionTime(Seconds)
                ...
                if Hours > 0 then
                    return string.format("%d:%02d:%02d", Hours, Minutes, SecondsRemaining)
                else
            ...
            RunService.RenderStepped:Connect(function()
                ...
                if CurrentTime - LastUpdate >= 1 then
                    FPS = math.round(FrameCount / (CurrentTime - LastUpdate))
                    ...
                    local SessionTime = FormatSessionTime(CurrentTime - SessionStart)

                    Watermark:SetText(string.format("%s | %d FPS | %d ms | %d Players | %s | %s", Name, FPS, Ping, PlayerCount, SessionTime, os.date("%I:%M %p")))
                end
            end)
        end)
    ...
    Library.ModList = function(self)
        ...
        local Items = { } do
            Items["ModList"] = Instances:Create("Frame", {
                ...
                AnchorPoint = Vector2New(0, 0.5),
                Name = "\0",
                Position = UDim2New(0, 15, 0.42, 0),
                Size = UDim2New(0, 0, 0, 18),
                BorderSizePixel = 2,
                AutomaticSize = Enum.AutomaticSize.XY,
                BackgroundColor3 = FromRGB(15, 15, 20)
            })
            Items["ModList"]:AddToTheme({
        ...
        function ModList:Add(Player)
            if not Player or Moderators[Player] then
                return
            end

            if not Player:FindFirstChild("IS_MOD") then
                return
            end

            local Mod = Instances:Create("TextLabel", {
                Parent = Items["Content"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(215, 215, 215),
                BorderColor3 = FromRGB(0, 0, 0),
            ...
            Mod:AddToTheme({TextColor3 = "Text"})
            ...
            Moderators[Player] = Mod

            return Mod
        end

        function ModList:Remove(Player)
            local Mod = Moderators[Player]
        ...
        local function SetupPlayer(Player)
            if Player:FindFirstChild("IS_MOD") then
                ModList:Add(Player)
            end

            Player.ChildAdded:Connect(function(Child)
                if Child.Name == "IS_MOD" then
                    ModList:Add(Player)
                end
            end)
    ...
    Library.TargetHUD = function(self)
        ...
        local Items = { } do
            ...
            Items["Info"] = Instances:Create("Frame", {
                Parent = Items["Content"].Instance,
                Name = "\0",
                Position = UDim2New(0, 58, 0, 0),
                Size = UDim2New(1, -58, 0, 50),
                BackgroundTransparency = 1,
                BorderSizePixel = 0
            })
            ...
            Items["DisplayName"]:AddToTheme({
                TextColor3 = "Text"
            })

            Instances:Create("UIStroke", {
                Parent = Items["DisplayName"].Instance,
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0"
            }):AddToTheme({
                Color = "Text Border"
            ...
            Items["Position"] = Instances:Create("TextLabel", {
                Parent = Items["Info"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(215, 215, 215),
                Text = "Position: None",
            ...
            Items["Position"]:AddToTheme({
                TextColor3 = "Text"
            })

            Instances:Create("UIStroke", {
                Parent = Items["Position"].Instance,
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0"
            }):AddToTheme({
                Color = "Text Border"
            ...
            Items["Knocked"] = Instances:Create("TextLabel", {
                Parent = Items["Info"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(215, 215, 215),
                Text = "Knocked: No",
            ...
            Items["Knocked"]:AddToTheme({
                TextColor3 = "Text"
            })

            Instances:Create("UIStroke", {
                Parent = Items["Knocked"].Instance,
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0"
            }):AddToTheme({
                Color = "Text Border"
            ...
            Items["HealthHolder"] = Instances:Create("Frame", {
                Parent = Items["Content"].Instance,
                Name = "\0",
                Position = UDim2New(0, -1, 0, 58),
                Size = UDim2New(1, 0, 0, 0),
                BorderSizePixel = 0,
                BackgroundTransparency = 1
            })

            Items["HealthBackground"] = Instances:Create("Frame", {
                Parent = Items["HealthHolder"].Instance,
                Name = "\0",
                Position = UDim2New(0, 0, 0, 1),
                Size = UDim2New(0.989, 0, 0, 7),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(30, 30, 35)
            })

            Items["HealthBackground"]:AddToTheme({
                BackgroundColor3 = "Inline"
            })

            Instances:Create("UIStroke", {
                Parent = Items["HealthBackground"].Instance,
                ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0",
                Color = FromRGB(27, 27, 32)
        ...
        local function UpdateHealth(Health, MaxHealth)
            ...
            if MaxHealth and MaxHealth > 0 then
                Percentage = math.clamp(Health / MaxHealth, 0, 1)
            end
        ...
        local function HookHumanoid(Character)
            ...
            UpdateConnection = RunService.RenderStepped:Connect(function()
                ...
                if RootPart then
                    ...
                    Items["Position"].Instance.Text = string.format(
                        "Position: %.0f, %.0f, %.0f",
                        Position.X,
                        Position.Y,
                        Position.Z
                    ...
                    Items["Position"].Instance.Text = "Position: None"
                end
                ...
                Items["Knocked"].Instance.Text =
                    "Knocked: " .. (Knocked and "Yes" or "No")
            end)
        end
        ...
        local function Update()
            if not Target or not Target.Parent then
                ...
                Items["DisplayName"].Instance.Text = "None"
                Items["Position"].Instance.Text = "Position: None"
                Items["Knocked"].Instance.Text = "Knocked: No"
                ...
                Items["Health"].Instance.Size = UDim2New(0, 0, 1, 0)
            ...
            Items["DisplayName"].Instance.Text = Target.DisplayName

            if Target.Character then
                HookHumanoid(Target.Character)
            else
                Items["Position"].Instance.Text = "Position: None"
                Items["Knocked"].Instance.Text = "Knocked: No"
        ...
        function TargetHUD:SetTarget(Player)
            ...
            CharacterConnection = Target.CharacterAdded:Connect(function(Character)
    ...
    Library.CreateKeybind = function(self, Data)
        ...
        if Data.Horizontal then
            Items["KeyButton"].Instance.AnchorPoint = Vector2New(0, 0)
            Items["KeyButton"].Instance.Position = UDim2New(0, 0, 0, 0)
            Items["KeyButton"].Instance.Size = UDim2New(0, 0, 1, 1)
            Items["KeyButton"].Instance.LayoutOrder = Data.LayoutOrder or 0
        end
            ...
            Items["Click"] = Instances:Create("TextButton", {
                Parent = Items["Window"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(215, 215, 215),
                BorderColor3 = FromRGB(0, 0, 0),
            ...
            Items["Click"]:AddToTheme({TextColor3 = "Text"})

            Instances:Create("UIStroke", {
                Parent = Items["Click"].Instance,
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0"
            }):AddToTheme({Color = "Text Border"})
        end
        ...
        function Keybind:Set(Key)
           ...
           elseif TableFind({"Toggle", "Hold", "Always", "Click"}, Key) then
                Keybind.Mode = Key
...
elseif Keybind.Mode == "Click" then
    Keybind.Toggled = true
    ...
    if Data.Callback then
        Library:SafeCall(Data.Callback, true)
    end

    Update()

    task.delay(0.15, function()
        if Keybind.Mode ~= "Click" then
            return
        end
...
Library:Connect(UserInputService.InputBegan, function(Input)
    ...
    if Input.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        Items["Click"]:Connect("MouseButton1Down", function()
            Keybind.Mode = "Click"
            Keybind:SetMode("Click")
        end)
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do 
            ...
            Items["MainFrame"].Instance.Position = UDim2New(0.5, 0, 0.5, -35)
...
function NewSection:Turn(Bool)
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        Items["KeybindHolder"] = Instances:Create("Frame", {
            Parent = Items["Toggle"].Instance,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            AnchorPoint = Vector2New(1, 0),
        ...
        Instances:Create("UIListLayout", {
            Parent = Items["KeybindHolder"].Instance,
            FillDirection = Enum.FillDirection.Horizontal,
